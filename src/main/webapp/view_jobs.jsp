      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               ...
               <% JobDAO dao=new JobDAO(DBconnect.getConn()); List<Jobs> list = dao.getAllJobs();
                  for (Jobs j : list) {
                  %>
                  <div class="card mt-2">
                     <div class="card-body">
                        ...
                        <h6>Publish Date:<%= j.getPdate() %>
                        </h6>
                        <div class=" text-center ">
                           <a href="edit_job.jsp?id=<%=j.getId() %>" class="btn btn-sm bg-primary text-white">Edit</a>
